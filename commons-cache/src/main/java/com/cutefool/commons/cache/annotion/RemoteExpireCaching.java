...
@Inherited
@Documented
@Cacheable(cacheManager = CachingConstants.REDIS_CACHE_MANAGER)
@Target({ElementType.TYPE, ElementType.METHOD})
@Retention(RetentionPolicy.RUNTIME)
public @interface RemoteExpireCaching {
    ...
    String cacheManager() default CachingConstants.REDIS_CACHE_MANAGER;
