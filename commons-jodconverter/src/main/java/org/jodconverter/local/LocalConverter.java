...
public class LocalConverter extends AbstractConverter {
   ...
   * OfficeManager} that will be used is the one holden by the {@link
   * InstalledOfficeManagerHolder} class, if any.
   *
   ...
   * OfficeManager} with default configuration.
   *
   * @param officeManager The {@link OfficeManager} the converter will
