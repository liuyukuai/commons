 ...
 */
public class KBParser extends Parser {
    ...
    protected KBParser(Configuration configuration, ParsingContext parsingContext, int peekDepth) {
    ...
    protected StatementType detectStatementType(String simplifiedStatement, ParserContext context) {
        ...
        if (PLSQL_REGEX.matcher(simplifiedStatement)
                       .matches() || PLSQL_PACKAGE_DEFINITION_REGEX.matcher(simplifiedStatement)
                                                                   .matches() || DECLARE_BEGIN_REGEX.matcher(simplifiedStatement)
                                                                                                    .matches()) {
