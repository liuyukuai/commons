...
public class KBDatabase extends Database<KBConnection> {

    public KBDatabase(Configuration configuration, JdbcConnectionFactory jdbcConnectionFactory, StatementInterceptor statementInterceptor) {
        super(configuration, jdbcConnectionFactory, statementInterceptor);
    }

    @Override
    protected KBConnection doGetConnection(Connection connection) {
        return new KBConnection(this, connection);
    }
